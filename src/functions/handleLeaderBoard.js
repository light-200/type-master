...
export function prepareLeaderboard() {
    ...
    leaderBoardHeader2.innerHTML = '<span class="leaderBoardRank">Rank</span><span class="leaderBoardUserName">Username</span><span class="leaderBoardSpeed">Top Speed</span>'
